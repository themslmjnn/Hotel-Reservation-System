...
str_20_uix_null_false = Annotated[str, mapped_column(String(20), unique=True, index=True, nullable=False)]
str_30_null_false = Annotated[str, mapped_column(String(30), nullable=False)]
